"""
RCA Investigations page (top menu) - the original RCA Categorization & Trend
Tool, unchanged apart from moving login/page config to app.py and chart
styling to chart_style.py.
...
from chart_style import (
    INK_MUTED, INK_PRIMARY, MAX_ROUTE_SERIES, SINGLE_SERIES, df_to_csv, route_color_map,
    style_fig,
)
